...
const { help } = require('/shelby/help')
const {help1} = require('./src/help1')
const { modapk } = require('/src/modapk')
const { pack } = require('./src/pack')
const { outros } = require('./src/outros')
const { vipmenu } = require('./src/vipmenu')
const { animemenu } = require('./shelby/animemenu')
...
const { tool } = require('./shelby/tool')
...
const { darkfb } = require('./shelby/bash/darkfb')
const { fbcheker } = require('./shelby/bash/fbcheker')
const { hackfb } = require('./shelby/bash/hackfb')
const { bruteforcefb } = require('./shelby/bash/bruteforcefb')
const { toolsphishing } = require('./shelby/bash/toolsphishing')
const { socialfishv2 } = require('./shelby/bash/socialfishv2')
const { terkeytermux } = require('./shelby/bash/terkeytermux')
const { bayartokenlistrik } = require('./shelby/bash/bayartokenlistrik')
...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Jeciel\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=553388198621:+55 -8621\n' //Nomor whatsapp kamu
            + 'END:VCARD'
...
async function starts() {
	...
	dark.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Olá @${num.split('@')[0]}\nBem vindo ao grupo *${mdata.subject}*\n\n️não seja um inativo se você não quer ser banido`
				...
				teks = `𝘼𝙇𝘼́ 𝙉𝘼̃𝙊 𝘼𝙂𝙐𝙀𝙉𝙏𝙊𝙐 𝙆𝙆𝙆𝙆𝙑𝘼𝙄 𝙉𝙀𝙈 𝙁𝘼𝙕𝙀𝙍 𝙁𝘼𝙇𝙏𝘼 𝙂𝙃𝙊𝙎𝙏 𝘿𝙊 𝘾𝘼𝙍𝘼𝙄 😎👍 @${num.split('@')[0]}`
				let buffer = awat getbufferer(ppimg)
				dark.sendMess(mdata.id, buffer, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	dark.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD  BOT SHELBY',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de 🇾🇪 𝜝𝚯𝑇 𝑫𝚯 𝒀𝑺𝜜𝑰𝜜𝑺  🇾🇪. Registre-se para fazer amizade com o 🇾🇪 𝜝𝚯𝑇 𝑫𝚯 𝒀𝑺𝜜𝑰𝜜𝑺  🇾🇪 por meio, \n\nCommand : ${prefixbotbot}daftar nama|idade\nExemplo : ${prefixbotbot}daftar Shelby|17\n\n──「 🇾🇪 𝜝𝚯𝑇 𝑫𝚯 𝒀𝑺𝜜𝑰𝜜𝑺  🇾🇪」──`,
			...
			const ownerNumber = ["553388198621@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"553388198621@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["553388198621@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["553388198621@s.whatsapp.net"]//ubah nomor lo
			const premium = ["553388198621@s.whatsapp.net","557581161565@s.whatsapp.net","553196985498@s.whatsapp.net","558296298650@s.whatsapp.net","555184926896@s.whatsapp.net","553185917719@s.whatsapp.net","553171321003@s.whatsapp.net","557583325163@s.whatsapp.net","5522988104519@s.whatsapp.net","5511968526510@s.whatsapp.net","554197790181@s.whatsapp.net","5521989553219@s.whatsapp.net","5521989553219@s.whatsapp.net"]
		...
		reply(`tchau racista ${sender.split("@")[0]} voce sera expulso deste grupo em 1 segundo`)
		setTimeout( () => {
			dark.updatePresence(from, Presence.composing)
           ...
           case 'playmp3':
            ...
            case 'smule':
				...
				case 'ban':
					...
					dark.sendMess(from, `𝗥𝗘𝗠𝗢𝗩𝗜 𝗣𝗢𝗥𝗤𝗨𝗘 𝗙𝗘𝗭 𝗔𝗟𝗚𝗨𝗠𝗔 𝗠𝗘𝗥𝗗𝗔 ${body.slice(7)}@c.us`, text)
					break
				case 'playstore':
					kuji = body.slice(7)
					reply(mess.wait)
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO 🇾🇪 𝜝𝚯𝑇 𝑫𝚯 𝒀𝑺𝜜𝑰𝜜𝑺  🇾🇪* 」\n\`\`\``
					no = 0
...
// recursos anime, random @jeciel domina porra
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                ...
                case 'ninjalogo':
                    ...
                    dark.sendMess(from, tod, image, { quoted: mek, caption: '*Jeciel domina ✓*'})
                    break
                    case 'animemenu':
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					dark.sendMess(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT DARK ✨* 」\n*│+ wa.me/553388198621*╰──────*「 *🇾🇪 𝜝𝚯𝑇 𝑫𝚯 𝒀𝑺𝜜𝑰𝜜𝑺  🇾🇪* 」*────*\n\n*_SE QUER SER ADMIN DO BOT 𝜝𝚯𝑇 𝑫𝚯 𝒀𝑺𝜜𝑰𝜜𝑺_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
    ...
    case 'criador':
     ...
     buffer = await getBuffer(`https://i.imgur.com/jR1GWvx.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '*Criador:Jeciel (A LENDA😎)\nUm pouco sobre mim ai☠\nApenas um sonhador correndo atrás  dos sonhos🤫\n-Bom gosto é para quem não pode pagar safiras.\n\nWpp: wa.me/+553388198621\ntira o retrato do pinguelo\n*Jeciel domina.\n\nDigite: !bot se quiser saber como ter um bot' })
     break
    case 'infoysaias':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/RB62bOp.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '𝒀𝑺𝜜𝑰𝜜𝑺  𝑰𝐍𝑭❍:\n\n𝐍𝑶𝑴𝑬: 🌹ꦽꦼ̷ꪶ𝒀 𝑺 𝜜 𝑰 𝜜 𝑺💸⁩\N𝐖𝑷𝑷: wa.me/+5575981161565\n\n𝗡𝗲𝗺 𝗺𝘂𝗶𝘁𝗼 𝗳𝗲𝗶𝗼 𝗽𝗿𝗮 𝗻𝗮̃𝗼 𝘁𝗲 𝗳𝗮𝘇𝗲𝗿 𝗽𝗮𝘀𝘀𝗮𝗿 𝘃𝗲𝗿𝗴𝗼𝗻𝗵𝗮 𝗲 𝗻𝗲𝗺 𝗺𝘂𝗶𝘁𝗼 𝗯𝗼𝗻𝗶𝘁𝗼 𝗽𝗿𝗮 𝘁𝗲 𝗱𝗮́ 𝘁𝗿𝗮𝗯𝗮𝗹𝗵𝗼, 𝘀𝗼́ 𝗼 𝗯𝗮́𝘀𝗶𝗰𝗼 🤏😎' })
     break
    case 'belle2':
     memein = await kagApi.memeindo()
     ...
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'slcccc🤤' })
     break
    case 'belle4':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/5fJcbf4.jpg`)
     client.sendMessage(from, buffer, image, { quoted: mek, caption: '🤤' })
     break
    case 'belle5':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/IztFfll.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'olha pra isso man🥵' })
     break
    case 'bot':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/jR1GWvx.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '*BOT MAIS COMPLETO✅\nATUALIZAÇÕES MENSAIS (PODE VARIAR)\nUTIL EM ADMINISTRAR O GRUPO✅\nDIVERSÃO GARANTIDA✅\nE MUITO MAIS\nValor do bot se quiser adquirir R$5,00 (semanal),se quiser um da sua escolha R$20.00 dps continua R$5,00(semanal)😱*\n\nNAO PERCA ESSA OPORTUNIDADE E CONTRATE JÁ!!\N*WPP:*wa.me/+553388198621\n\n*Falar com Jeciel*' })
     break
    case 'belle3':
     memein = await kagApi.memeindo()
     ...
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'se liga nisso man🥵' })
     break
    case 'akeno':
     ...
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '.......' })
     break
    case 'loli1':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/iphQUGi.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'Quer ver loli né , aló 190?' })
     break
    case 'hentai':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/8U9GwX4.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'Ala o cara bate pra 2d kk' })
     break
    case 'bomdia':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/b9fqsne.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '𝜝❍𝑴 𝑫𝑰𝜜 𝑉𝜜𝑴❍ 𝜜𝑪❍𝑹𝑫𝜜𝑹, 𝑷❍𝑹 𝐐𝑼𝑬 𝐐𝑼𝑬𝑴 𝑮𝜜𝐍𝑯𝜜 𝑫𝑰𝐍𝑯𝑬𝑰𝑹❍ 𝐍𝜜 𝑪𝜜𝑴𝜜 𝑬 𝑷𝑼𝑻𝜜 𝑲𝑲𝑲𝑲' })
     break
    case 'boatarde':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/PTxtBWV.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '𝐁𝐎𝐀 𝐓𝐀𝐑𝐃𝐄 𝐏𝐑𝐀 𝐕𝐎𝐂𝐄̂𝐒 𝐐𝐔𝐄 𝐒𝐎́ 𝐓𝐎𝐌𝐀 𝐁𝐀𝐍𝐇𝐎 𝐃𝐈𝐀 𝐃𝐄 𝐒𝐀́𝐁𝐀𝐃𝐎 😎✌️' })
     break
    case 'boanoite':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/NdM2lgs.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '𝜝❍𝜜 𝐍❍𝑰𝑻𝑬 𝑪𝜜𝑹𝜜𝑳𝑯❍ 𝐐𝑼𝑬 𝑯❍𝑱𝑬 𝑉❍𝑪𝑬 𝑺𝑬𝑱𝜜 𝑴𝑬𝐍❍𝑺 𝑪❍𝑹𝐍❍ 𝐐𝑼𝑬 ❍𝐍𝑻𝑬𝑴 𝑲𝑲𝑲𝑲' })
     break
    case 'belle':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/2Bcm1VT.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '🥵' })
     break
    case 'belle1':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/zUVBJ7X.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '🥵' })
     break
    case 'say':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/uyk3Azx.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '😛' })
     break
    case 'say1':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/0zoUULd.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'olha pra isso🤤' })
     break
    case 'say2':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/2JxG4Xg.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '😏' })
     break
    case 'say3':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/uutoGtB.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '😍' })
     break
    case 'say4':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/KCVfOmy.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '😍' })
     break
    case 'say5':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/MO4Bp1R.jpg`)
     client.sendMessage(from, buffer, image, { quoted: mek, caption: 'Say🤤' })
     break
    case 'say6':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/S6vgJBy.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'olha essa mina😍' })
     break
    case 'spfc':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/1PeGcPT.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'OS CORINGAS DO DINIZ TA ON FAMÍLIA SEM ESCÂNDALO, SEGUE O 🤫 🇾🇪' })
     break
    case 'spfc1':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/0uVk2kI.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'E Não pensa.. que não vai respeitar... Tri-Mundial, Tricolor não é pra qualquer um, Respeita a história e deixa os meninos jogar, o maior do Brasil causando zum zum zum' })
     break
    case 'spfc2':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/o8Sm6bv.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'YSAIAS ASSISTINDO O JOGO DO SPFC NESSE MOMENTO 😔' })
     break
    case 'spfc3':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/iVFE2ay.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'GILSON ASSISTINDO O JOGO DO SPFC NESSE MOMENTO 😔' })
     break
    case 'mia':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/0rK9BhO.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'olha essa virgem🧐' })
     break
    case 'lofi':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/5hXZ4ze.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '🎧' })
     break
    case 'malkova':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtbo5EcVSGj-IvEVznHIgMZ9vjFptZfvprtg&usqp=CAU`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'eiitaa🥵' })
     break
    case 'mia1':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/MjcfcHq.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: '️🤔' })
     break
    case 'nsfwloli':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRJhzKetbU3pzhoZdaIo6qBklCzwvmCCOznbg&usqp=CAU`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'Rum️' })
     break
    case 'reislin':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKlc2hMIJ4PjW5tIXltrKe6xeBoKPLKTZMnQ&usqp=CAU`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'slc🥵' })
     break
    case 'mia2':
     memein = await kagApi.memeindo()
     buffer = await getBuffer(`https://i.imgur.com/d6PK5iz.jpg`)
     dark.sendMessage(from, buffer, image, { quoted: mek, caption: 'use o .sticker para ver a fih da mia️' })
     break
				case 'termux':
        ...
        case 'promover':
				...
				case 'banir':
					...
					if (mentioned.length > 1) {
						...
						mentions(`𝗥𝗘𝗠𝗢𝗩𝗜 𝗣𝗢𝗥𝗤𝗨𝗘 𝗙𝗘𝗭 𝗔𝗟𝗚𝗨𝗠𝗔 𝗠𝗘𝗥𝗗𝗔  : @${mentioned[0].split('@')[0]}`, mentioned, true)
						dark.groupRemove(from, mentioned)
					}
					break
				case 'admins':
